...
const CSE = ({ toggleHover }) => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="page-hero-premium enterprises-hero with-bg" style={{ backgroundImage: 'url("/entreprises-hero-bg.jpg")' }}>
        ...
        <div className="container">
           <div className="grid-2 align-center">
            <div className="business-detail-img">
               <img src="/hero-bg.jpg" alt="Club Padel Signature Montauban" className="img-premium-border" style={{ borderRadius: '12px' }} />
            </div>
