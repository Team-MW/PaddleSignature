    ...
    <>
      ...
      <div style={{ paddingTop: '60px', minHeight: '100vh', backgroundColor: 'var(--white)', paddingBottom: '5rem' }}>
        <div className="container" style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          {/* Breadcrumb */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--terracotta)', fontWeight: 'bold', fontSize: '0.8rem', marginBottom: '3rem', textTransform: 'uppercase' }}>
            <Link to="/" style={{ color: 'inherit', display: 'flex', alignItems: 'center' }} onMouseEnter={toggleHover} onMouseLeave={toggleHover}><Home size={16} /></Link>
            <span>&gt;</span>
            <span>Comment réserver</span>
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.6rem', color: 'var(--terracotta)', fontWeight: 'bold', fontSize: '0.75rem', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '2rem', backgroundColor: 'rgba(164, 87, 41, 0.1)', padding: '0.6rem 1.2rem', borderRadius: '50px' }}>
            ...
            <h1 className="serif" style={{ fontSize: 'clamp(3rem, 8vw, 4.5rem)', marginBottom: '1rem', lineHeight: '1', color: 'var(--dark-green)', textTransform: 'uppercase' }}>
              RÉSERVEZ EN<br/>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', textAlign: 'left', width: '100%' }}>
              ...
              <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 style={{ color: 'var(--dark-green)', fontWeight: 'bold', textTransform: 'uppercase', fontSize: '1.1rem', letterSpacing: '0.05em', marginBottom: '0.5rem' }}>CRÉEZ VOTRE COMPTE</h4>
                  <p style={{ color: 'var(--text-muted)', fontSize: '1rem', margin: 0, lineHeight: '1.5' }}>Renseignez vos informations pour accéder à votre espace joueur et activer vos notifications.</p>
                </div>
              </div>
              <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--text-muted)', fontSize: '1rem', margin: 0, lineHeight: '1.5' }}>Consultez les disponibilités en temps réel et sélectionnez le jour, l'horaire et le terrain. Les heures creuses sont à tarif réduit.</p>
                </div>
              </div>
              <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--text-muted)', fontSize: '1rem', margin: 0, lineHeight: '1.5' }}>Payez la totalité du terrain, seulement votre part, ou utilisez vos crédits. Annulation possible jusqu'à 24 heures avant.</p>
                </div>
              </div>
            </div>
