      ...
      <div style={{ paddingTop: '120px', minHeight: '100vh', backgroundColor: 'var(--white)', paddingBottom: '5rem' }}>
        <div className="container" style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            ...
            {/* Lien web discret */}
            <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginTop: '0.8rem', marginBottom: '2rem', textAlign: 'center' }}>
              Pas de smartphone ?{' '}
              <a
                href="https://padel-signature.mymobileapp.fr"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: 'var(--terracotta)', textDecoration: 'underline', fontWeight: '500' }}
              >
