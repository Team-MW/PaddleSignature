      ...
      <div className="container hero-content-centered">
        ...
        >
          ...
          <div className="hero-cta-centered">
            <Link to="/infos#reservation-form" className="btn" onMouseEnter={toggleHover} onMouseLeave={toggleHover} style={{ backgroundColor: 'var(--terracotta)', color: 'white', padding: '1.2rem 3rem', textTransform: 'uppercase', letterSpacing: '0.15em', fontWeight: 'bold' }}>
              RÉSERVER UN TERRAIN
            </Link>
          </div>
